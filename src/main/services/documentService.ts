...
export class DocumentService {
  ...
  static async exportInvoice(saleId: number, format: 'PDF' | 'PRINT'): Promise<void> {
  ...
  static async exportPrescription(prescriptionId: number, format: 'PDF' | 'PRINT'): Promise<void> {
