  ...
  static createAdjustment(
    ...
    return executeTransaction(DatabaseManager.getInstance(), () => {
      ...
      const batch = db
        ...
        .get(payload.inventory_batch_id) as InventoryBatch | undefined;
      if (!batch) {
        throw new ApiError(
          404,
          `Inventory batch with ID ${payload.inventory_batch_id} not found`,
        );
      }
      ...
      return StockAdjustmentRepository.findById(
